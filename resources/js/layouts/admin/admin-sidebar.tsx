        ...
        items: [
            {
                ...
                subItems: [
                    { label: 'Umum & Tampilan', href: '/cms/settings/umum' },
                    { label: 'Peringatan & Peta', href: '/cms/settings/peringatan' },
                    { label: 'AI & Analitik', href: '/cms/settings/ai' },
                    { label: 'Integrasi Sistem', href: '/cms/settings/integrasi' },
