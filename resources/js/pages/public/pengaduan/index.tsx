                ...
                <div className="max-w-2xl mx-auto">
                    <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
                        ...
                        <p className="text-gray-600 mb-6">
                            Terima kasih atas laporan Anda. Tim kami akan segera meninjaunya.
                        </p>

                        {/* Kode Laporan - Enhanced */}
                        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-6 mb-6">
                            <p className="text-sm text-blue-600 mb-2 font-medium">Kode Laporan Anda:</p>
                            <div className="flex items-center justify-center gap-3">
                                <p className="text-4xl font-bold text-blue-700 font-mono tracking-wider">{kodeLaporan}</p>
                                <button
        ...
        <>
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">Lapor Bencana</h1>
                    <p className="text-gray-600">
                        Laporkan kejadian bencana di sekitar Anda. Laporan Anda membantu kami merespons lebih cepat.
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-lg p-6 md:p-8 space-y-6">
                    ...
                    <div className="pt-4">
                        <button
                            ...
                            className="w-full py-3 px-6 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                        >
                            {isSubmitting ? (
                                <>
                ...
                <div className="mt-6 text-center text-sm text-gray-500">
                    <p>Setelah mengirim, Anda akan menerima kode laporan untuk melacak status.</p>
                    <p className="mt-1">
                        Butuh bantuan?{' '}
                        <a href="/public/kontak" className="text-blue-600 hover:underline">
                            Hubungi kami
                        </a>
                    </p>
                </div>
